...
testSum(void) {
    ...
    ensure(floatEqual(s1, 10), "sum test 1");
    //
    vector<float> v2 = {1, 2, 3, 4, 5, 6};
    float s2 = sum(v2);
    ensure(floatEqual(s2, 21), "sum test 2");
}
...
testProduct(void) {
    ...
    float s1 = product(v1);
    // 判断浮点数相等，建议使用 floatEqual 函数
    ensure(floatEqual(s1, 24), "testProduct 1");
    //
    vector<float> v2 = {1, 2, 3, 4, 5};
    float s2 = product(v2);
    ensure(floatEqual(s2, 120), "testProduct 2");
}
// 作业 2
// 返回一个数字的绝对值
// 函数定义如下
...
testAbs1(void) {
    ...
    float s1 = abs1(v1);
    // 判断浮点数相等，建议使用 floatEqual 函数
    ensure(floatEqual(s1, 2), "testabs1 1");
    //
    float v2 = -3;
    float s2 = abs1(v2);
    ensure(floatEqual(s2, 3), "testabs1 2");
}
...
testAverage(void) {
    ...
    float s1 = average(v1);
    // 判断浮点数相等，建议使用 floatEqual 函数
    ensure(floatEqual(s1, 2.5), "testAverage 1");
    //
    vector<float> v2 = {1, 2, 3, 4, 5};
    float s2 = average(v2);
    ensure(floatEqual(s2, 3), "testAverage 2");
}
...
testMin1(void) {
    ...
    float s1 = min1(v1);
    // 判断浮点数相等，建议使用 floatEqual 函数
    ensure(floatEqual(s1, 1), "testMin1 1");
    //
    vector<float> v2 = {2, 3, 4, 5};
    float s2 = min1(v2);
    ensure(floatEqual(s2, 2), "testMin1 2");
}
// 作业 5
// 参数是一个数字 n
// 返回以下序列的结果
...
testSum1(void) {
    ...
    float s1 = sum1(v1);
    // 判断浮点数相等，建议使用 floatEqual 函数
    ensure(floatEqual(s1, 2), "sum1 1");
    //
    int v2 = 4;
    float s2 = sum1(v2);
    ensure(floatEqual(s2, -2), "sum1 2");
}
...
testSum2(void) {
    ...
    float s1 = sum1(v1);
    // 判断浮点数相等，建议使用 floatEqual 函数
    ensure(floatEqual(s1, 0), "testSum2 1");
    //
    int v2 = 4;
    float s2 = sum1(v2);
    ensure(floatEqual(s2, 4), "testSum2 2");
}
...
testFac1(void) {
    ...
    float s1 = sum1(v1);
    // 判断浮点数相等，建议使用 floatEqual 函数
    ensure(floatEqual(s1, 6), "testFac1 1");
    //
    int v2 = 4;
    float s2 = sum1(v2);
    ensure(floatEqual(s2, 24), "testFac1 2");
}
//
void
test() {
